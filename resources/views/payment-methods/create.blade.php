...
@section('title', __('adminlte.create_payment_method'))

@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>{{ __('adminlte.create_payment_method') }}</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">{{ __('adminlte.create') }}</li>
            </ol>
        </div>
    </div>
@stop
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('instructions') is-invalid @enderror" 
                                      ...
                                      placeholder="{{ __('adminlte.payment_instructions_placeholder') }}">{{ old('instructions') }}</textarea>
                            @error('instructions')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control @error('min_amount') is-invalid @enderror" 
                                               id="min_amount" name="min_amount" value="{{ old('min_amount', '1.00') }}" 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control @error('processing_fee_fixed') is-invalid @enderror" 
                                               ...
                                               value="{{ old('processing_fee_fixed', '0.00') }}" step="0.01" min="0">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control @error('processing_fee_percentage') is-invalid @enderror" 
                                               ...
                                               value="{{ old('processing_fee_percentage', '0.00') }}" 
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('processing_time_min') is-invalid @enderror" 
                                           ...
                                           value="{{ old('processing_time_min', '0') }}" min="0">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('processing_time_max') is-invalid @enderror" 
                                           ...
                                           value="{{ old('processing_time_max', '60') }}" min="0">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="url" class="form-control @error('gateway_url') is-invalid @enderror" 
                                           id="gateway_url" name="gateway_url" value="{{ old('gateway_url') }}">
                                    @error('gateway_url')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                ...
                <div class="card card-secondary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input" id="requires_verification" 
                                       name="requires_verification" value="1" {{ old('requires_verification') ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" id="supported_countries" name="supported_countries[]" 
                                ...
                                <option value="US" {{ in_array('US', old('supported_countries', [])) ? 'selected' : '' }}>United States</option>
                                <option value="GB" {{ in_array('GB', old('supported_countries', [])) ? 'selected' : '' }}>United Kingdom</option>
                                <option value="CA" {{ in_array('CA', old('supported_countries', [])) ? 'selected' : '' }}>Canada</option>
                                <option value="AU" {{ in_array('AU', old('supported_countries', [])) ? 'selected' : '' }}>Australia</option>
                                <option value="DE" {{ in_array('DE', old('supported_countries', [])) ? 'selected' : '' }}>Germany</option>
                                <option value="FR" {{ in_array('FR', old('supported_countries', [])) ? 'selected' : '' }}>France</option>
                                <option value="AE" {{ in_array('AE', old('supported_countries', [])) ? 'selected' : '' }}>UAE</option>
                                <option value="SA" {{ in_array('SA', old('supported_countries', [])) ? 'selected' : '' }}>Saudi Arabia</option>
                                <option value="EG" {{ in_array('EG', old('supported_countries', [])) ? 'selected' : '' }}>Egypt</option>
                            </select>
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-primary btn-block">
                            <i class="fas fa-save"></i> {{ __('adminlte.create_payment_method') }}
                        </button>
