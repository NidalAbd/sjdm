...
return [
    ...
    'why_choose_us' => 'Why Choose Our SMM Panel Services',
    'cheapest_fastest_services' => 'Cheapest & Fastest Services SMM Panel ',
    'cheapest_fastest_description' => 'Get the best value for your money with our competitive pricing and lightning-fast delivery',
    'cheapest_fastest_services_icon' => 'Cheapest & Fastest Services Icon SMM Panel ',
    'super_fast_delivery' => 'Super Fast Delivery SMM Panel ',
    'super_fast_delivery_description' => 'Experience rapid delivery times with our optimized service infrastructure',
    'super_fast_delivery_icon' => 'Super Fast Delivery Icon SMM Panel',
    'support_24_7' => 'Support 24/7 SMM Panel ',
    'support_24_7_description' => 'Our dedicated support team is available round the clock to assist you',
    'support_24_7_icon' => 'Support 24/7 Icon SMM Panel',
    'many_payment_methods' => 'Many Payment Methods',
    'many_payment_methods_description' => 'Choose from a wide variety of secure payment options',
    'many_payment_methods_icon' => 'Many Payment Methods Icon',
    'friendly_dashboard' => 'Friendly Dashboard',
    'friendly_dashboard_description' => 'Navigate easily with our intuitive and user-friendly interface',
    'friendly_dashboard_icon' => 'Friendly Dashboard Icon',
    'updates_page' => 'Updates Page for Services',
    'updates_page_description' => 'Stay informed with real-time service updates and announcements',
    ...
    'new_registrations' => 'New registrations in the last 24 hours',
    'completed_transactions' => 'Completed transactions in the last 24 hours',
    'new_orders' => 'New orders placed in the last 24 hours',
    'total_registered' => 'Total registered users',
    'total_completed' => 'Total completed transactions',
    'total_processed' => 'Total processed orders',
    ...
    'orders_waiting_for_api' => 'Orders Waiting for API Processing',
    'orders_waiting_message' => 'There are {count} orders with waiting status. This usually indicates insufficient API balance or API issues.',
    'api_balance' => 'API Balance',
    'current_api_balance' => 'Current API Balance',
    'add_api_balance' => 'Add API Balance',
    'view_waiting_orders' => 'View Waiting Orders',
    ...
    'choose_your_platform' => 'Choose your preferred platform to get started',
    'all' => 'all',
    'facebook' => 'Facebook',
    'facebook_description' => 'Boost your Facebook presence with real followers',
    'instagram' => 'Instagram',
    'instagram_description' => 'Increase your Instagram followers and engagement',
    'tiktok' => 'TikTok',
    'tiktok_description' => 'Grow your TikTok audience with authentic followers',
    'google' => 'Google',
    'google_description' => 'Improve your Google reviews and ratings',
    'twitter' => 'Twitter',
    'twitter_description' => 'Expand your Twitter following and reach',
    'youtube' => 'YouTube',
    'youtube_description' => 'Boost your YouTube subscribers and views',
    'spotify' => 'Spotify',
    'spotify_description' => 'Increase your Spotify followers and plays',
    'snapchat' => 'Snapchat',
    'snapchat_description' => 'Grow your Snapchat following and engagement',
    'linkedin' => 'LinkedIn',
    'linkedin_description' => 'Build your professional LinkedIn network',
    'telegram' => 'Telegram',
    'telegram_description' => 'Expand your Telegram channel subscribers',
    'discord' => 'Discord',
    'discord_description' => 'Grow your Discord server members',
    'reviews' => 'Reviews',
    'reviews_description' => 'Get authentic reviews for your business',
    'twitch' => 'Twitch',
    'traffic' => 'Traffic',
    ...
    'video_link_note' => 'Video link, post link, or profile link',
    ...
    'no_payment_methods_available' => 'No payment methods available at the moment.',
    'minimum_amount_10' => 'Minimum amount is $10.00',
    'minimum_deposit_10' => 'Minimum deposit amount is $10.00',
    'selected_payment_method' => 'Selected Payment Method',
    'crypto_not_available' => 'Cryptocurrency payments are currently unavailable',
    'crypto_payments' => 'Cryptocurrency Payments',
    'contact_admin_manual' => 'Contact Admin for Manual Transaction',
    'coming_soon' => 'Coming Soon',
    'free' => 'Free',
    'available_options' => 'Available Options',
    'primary_method' => 'Primary Method',
    'secure_payments' => 'Secure Payments',
    'secure_payments_desc' => 'All transactions are encrypted and protected with industry-standard security protocols.',
    'instant_processing' => 'Instant Processing',
    'instant_processing_desc' => 'Most payments are processed instantly and reflected in your account immediately.',
    '24_7_support' => '24/7 Support',
    '24_7_support_desc' => 'Our support team is available around the clock to assist you with any payment issues.',
    'select_payment_option' => 'Select payment option to add balance to your funds for trading.',
    'deposit_amount' => 'Deposit Amount',
    'select_payment_and_continue' => 'SELECT PAYMENT AND CONTINUE',
    'save_as_default_payment' => 'Save as default payment',
    'we_accept_all_payments' => 'We accept all types of payments and',
    'see_how_secure' => 'See how it is secure?',
    'add_funds_unlock_positions' => 'Add Funds to unlock free trade positions',
    'free_trade_positions' => 'Free Trade Positions',
    'unlock_positions_description' => 'Unlock 5 free positions for each step you complete which is 100% insured trade positions.',
    'total' => 'Total',
    ...
    'create_first_payment_method' => 'Create your first payment method',
    ...
    'payment_method_activated_successfully' => 'Payment method activated successfully',
    'payment_method_deactivated_successfully' => 'Payment method deactivated successfully',
    'payment_methods_activated_successfully' => 'Selected payment methods activated successfully',
    'payment_methods_deactivated_successfully' => 'Selected payment methods deactivated successfully',
    'payment_methods_deleted_successfully' => 'Selected payment methods deleted successfully',
    'cannot_delete_payment_method_with_transactions' => 'Cannot delete payment method with existing transactions',
    'cannot_delete_payment_methods_with_transactions' => 'Cannot delete payment methods with existing transactions',
    'cannot_delete_payment_method_in_use' => 'Cannot delete payment method that is being used in transactions',
    'cannot_delete_payment_methods_in_use' => 'Cannot delete payment methods that are being used in transactions',
    'confirm_delete_payment_method' => 'Are you sure you want to delete payment method',
    'payment_type' => 'Payment Type',
    'select_type' => 'Select Type',
    'payment_limits_fees' => 'Payment Limits & Fees',
    'minimum_amount' => 'Minimum Amount',
    'maximum_amount' => 'Maximum Amount',
    'fixed_processing_fee' => 'Fixed Processing Fee',
    'percentage_processing_fee' => 'Percentage Processing Fee',
    ...
    'requires_kyc_verification' => 'Requires KYC verification',
    ...
    'leave_empty_all_countries' => 'Leave empty to support all countries',
    'leave_empty_keep_current' => 'Leave empty to keep current value',
    'payment_instructions' => 'Payment Instructions',
    'payment_instructions_placeholder' => 'Enter payment instructions here...',
    ...
    'please_select_payment_methods' => 'Please select payment methods',
    'please_select_action' => 'Please select an action',
    'confirm_delete_selected_payment_methods' => 'Are you sure you want to delete the selected payment methods?',
    'filters' => 'Filters',
    'clear' => 'Clear',
